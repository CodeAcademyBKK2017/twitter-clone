      ...
      return (
        <div>
          ...
          <div className={classNames(headerStyle.header_mobile, headerStyle.box_shadow, headerStyle.background_white)}>
            <div className={headerStyle.left_head} onClick={this.menuclickHandler}>
          ...
          <div className={classNames(headerStyle.menuBar, {[headerStyle.activeMenu]: this.state.showVisible})}>
